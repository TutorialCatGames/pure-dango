...
// the sets for types
const keywordSet = new Set(["new","if","else","while","continue","break","for","function","return","import","class","extends","inst","internal","try","catch","finally","do","switch","case","default"]);
